...
{
    class ProductModel : IDataErrorInfo
    {
        ...
        public string this[string columnName]
        {
            get
            {
                ...
                if (columnName == "PRODUCT_CODE" && string.IsNullOrWhiteSpace(PRODUCT_CODE))
                {
                    error = "PRODUCT CODE is required!";

                }

                if (columnName == "DESCR" && string.IsNullOrWhiteSpace(DESCR))
                {
                    error = "DESCRIPTION is required!";

                }

                if (columnName == "BIN" && string.IsNullOrWhiteSpace(BIN))
                {
